...
const TravelAssistantPanel = ({ isOpen, onClose }) => {
  ...
  const handleSendMessage = async (messageText = inputMessage) => {
    // Properly extract text from messageText, handling both strings and objects
    let textContent = '';
    ...
    if (textContent.trim() !== '') {
      ...
      setTimeout(async () => {
        ...
        // 4. Trip Planning / Recommendations
          ...
          // Handle common typo: "romatic" instead of "romantic"
        ...
        if (!matched) {
          ...
          try {
            ...
            if (cohereResponse && cohereResponse.startsWith('Error:')) {
              // Fallback to a helpful response instead of showing the error
  ...
  return (
    <>
      ...
      <div style={panelStyle}>
        ...
        {/* Sticky footer: input + terms anchored to bottom */}
